...
<body>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Datos de usuario cliente</h3>
  ...
  <div class="register-form">
    <?php		
		...
		$stmt = $conexion->prepare("SELECT first_name, last_name, address, phone_number, email FROM user_register WHERE username = ?");
        $stmt->bind_param("s", $_SESSION['username']); // "s" indica que el parámetro es una cadena (string)
        $stmt->execute();
		...
		echo "<p>Direccion: " . $row['address'] . "</p>";
		echo "<p>Telefono: " . $row['phone_number'] . "</p>";
