...
<div class="login-form">
    <h2>Ingresa</h2>
    <form action="inicio_usuario.php">
      ...
      <button type="submit" name="proc" class="btn-login">Iniciar Sesión</button>
      <div class="text-center" style="margin-top: 20px;">
        <p style="margin-bottom: 20px;">¿Aún no estás registrado? ¡Te estás perdiendo de grandes ventajas! Únete a nuestra comunidad y disfruta de una experiencia de compra única. <a href="register.php" class="register-link">Registrate aquí</a></p>
     </div> 
    </form>
